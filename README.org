...
*Emacs onboarding made easy – single-file Emacs starter kit without 3rd-party packages.*
Almost vanilla Emacs, with just the right amount of sweetness to flatten the learning curve.
Unlike others, it's not supposed to replace your ~init.el~, but loaded from there as a library (see installing instructions down below).
