...
One thing I cannot stress enough: The seemingly weird keybindings are not what makes Emacs. They are in fact secondary.

The /commands/ are the really interesting things. All those keybindings are just convenience shortcuts to use those commands, but they are not those commands themselves.
...
- "M-x help" to reach the ultimate help master menu

- "M-x describe-key" find out what some key combination does


*** And the second important one is this:
