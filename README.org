...
Overwhelmed by complex Emacs distros like Doom-Emacs or Spacemacs? You want to roll your own Emacs config bottom-up, but not overlook those easy-to-miss basics? Or you don't want to configure Emacs at all? But ... /just use it/??? 🤯

The ONBOARD Emacs starter kit is your clean slate to build upon. It's vanilla Emacs, but gives you convenience and a better user experience, without relying on additional 3rd-party packages.
...
- Configuration based on Use-package in Emacs ONBOARD is postponed until Emacs 29 is in the Debian Stable repos; however ist will be [[https://github.com/monkeyjunglejuice/emacs.ontop][available in the Emacs ONTOP extension layer]] (coming soon).
