...
- Portability: Should work on recent Linux/Unix, Windows and MacOS systems; Emacs versions >= 26
...
- Pre-configure everything and the cat's pillow
...
If you think this is something the (Emacs) world needs, you're welcome to send pull requests.
