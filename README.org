...
*2.* Put this in your Emacs init file (replace "path/to" with your actual path):
...
/With a freshly installed Emacs there is no init file./
/But you can ask Emacs where it expects to find the init file:/
