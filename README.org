...
- *Be as un-opinionated as possible* -- there's no "one-fits-all", and you should be able to make your Emacs whatever you want it to be. Emacs ONBOARD removes the need for caring about the mundane stuff.
