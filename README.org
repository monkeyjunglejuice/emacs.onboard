...
/Don't have a init file or don't know where it is?/

Emacs knows: "M-x describe-variable" <RET> user-init-file
That could be …
on Linux/Unix: =/home/USERNAME/.emacs= or =/home/USERNAME/.emacs.d/init.el= 
on Windows: =c:\Users\USERNAME\AppData\Roaming\.emacs=
