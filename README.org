* 🚀 Emacs is like an ancient starship from a highly advanced alien civilization, found half-buried in the Amazon jungle.
...
- Tree-sitter: handle language grammars and build/install them declaratively
